...
const DIRECT_LAUNCH_FACTORY_ABI = [
  {
    "inputs": [
      { "internalType": "string", "name": "name",   "type": "string" },
      { "internalType": "string", "name": "symbol", "type": "string" },
...
module.exports = { TOKEN_FACTORY_ABI, BONDING_CURVE_ABI, TOKEN_TEMPLATE_ABI, DIRECT_LAUNCH_FACTORY_ABI, PANCAKE_ROUTER_ABI, ERC20_ABI };