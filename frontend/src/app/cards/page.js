        ...
        >
            ...
            <div className="relative z-10">
                ...
                <div className="pt-8 border-t border-gray-50 flex items-center justify-between">
                    ...
                    <button className="px-8 py-4 bg-gray-900 text-white rounded-2xl font-black text-xs uppercase tracking-widest hover:bg-amber-500 transition-all flex items-center gap-2 group">
            ...
            <div className="pt-32 pb-20 px-6 md:px-12">
                <div className="max-w-7xl mx-auto text-center mb-24">
                    ...
                    <h1 className="text-5xl md:text-8xl font-black text-gray-900 tracking-tighter mb-8 leading-none">
                        CRYPTO <span className="text-amber-500">REALITY</span>
                    </h1>
                        ...
                        <div className="mt-24 pt-16 border-t border-white/5 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                            {[
                                ...
                                <div key={i} className="flex items-center gap-4">
                                    <div className="w-10 h-10 rounded-xl bg-white/5 flex items-center justify-center text-amber-500 select-none">
                                        {stat.icon}
                                    </div>
                                    <div>
