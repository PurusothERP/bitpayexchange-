    ...
    return (
        ...
        >
            <div className="absolute top-0 right-0 p-8 opacity-5 group-hover:scale-110 transition-transform">
                <Rocket className="w-20 h-20 text-teal-600" />
            </div>
            ...
            <div className="grid grid-cols-2 gap-3 mb-6">
                ...
                <div className="bg-gray-50 rounded-2xl p-4 border border-black/5">
                    ...
                    <p className="text-sm font-black text-teal-600">{formatSupply(lockedBalance)}</p>
                </div>
            </div>
                        ...
                        {activeTab === 'tokens' && (
                            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-8">
                                <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                                    <h2 className="text-2xl font-black uppercase tracking-tighter italic">Managed <span className="text-teal-600">Assets</span></h2>
                                ...
                                {loadingTokens ? (
                                    ...
                                    <div className="bg-white border border-black/5 rounded-[3rem] p-20 text-center shadow-sm">
                                        ...
                                        <Link href="/exchange" className="inline-flex items-center gap-2 px-8 py-3 bg-teal-600 text-white font-black rounded-xl text-[10px] uppercase tracking-widest shadow-xl shadow-teal-200/20">Launch New Project</Link>
                                    </div>
                                ) : (
                                                ...
                                                {futuresPositions.map(pos => (
                                                    <tr key={pos.id} className="hover:bg-gray-50/50 transition-colors">
                                                        ...
                                                        <td className="py-6 px-8">
                                                            ...
                                                            <span className="text-[10px] font-black text-teal-600">{pos.leverage}x Leverage</span>
                                                        </td>
