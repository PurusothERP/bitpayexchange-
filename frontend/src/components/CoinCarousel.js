        ...
        <div className="relative py-20 px-4 md:px-8">
            <div className="max-w-7xl mx-auto">
                <div className="text-center mb-12">
                    <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-teal-500/10 border border-teal-500/20 text-teal-600 text-sm font-bold uppercase tracking-widest mb-4">
                ...
                <div className="flex justify-center gap-2 mb-8">
                    {coins.map((_, i) => (
                        <button
                            key={i}
                            onClick={() => setIndex(i)}
                            className={`rounded-full transition-all duration-300 ${i === index ? 'w-6 h-2 bg-teal-500' : 'w-2 h-2 bg-black/15 hover:bg-black/30'}`}
                        />
                    ))}
                </div>
                ...
                <AnimatePresence mode="wait">
                    <motion.div
                        ...
                        className="glass-card bg-gradient-to-br from-white/80 to-white/40 border-teal-500/10 max-w-3xl mx-auto p-8 md:p-10"
                        style={{
                    ...
                    >
                        <div className="flex flex-col md:flex-row gap-8 items-center md:items-start">
                            ...
                            <div className="relative flex-shrink-0">
                                ...
                                <div className="absolute -top-2 -right-2 w-7 h-7 rounded-full bg-teal-500 text-white text-xs font-black flex items-center justify-center shadow-md">
                                    #{index + 1}
                                </div>
                            </div>
