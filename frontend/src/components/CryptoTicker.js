...
export default function CryptoTicker() {
    ...
    return (
        <div className="fixed top-20 left-0 right-0 z-40 overflow-hidden h-9 bg-gradient-to-r from-gray-900/95 via-gray-800/95 to-gray-900/95 border-b border-teal-500/20 backdrop-blur-sm">
            {/* Left fade */}
