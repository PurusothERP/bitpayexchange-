...
export default function NetworkGuard({ children }) {
    ...
    return (
        <>
            ...
            <div className="fixed top-0 left-0 right-0 z-[200] bg-teal-500 text-white py-2.5 px-4 flex items-center justify-between gap-4 shadow-xl">
                ...
                <div className="flex items-center gap-2 shrink-0">
                    <button
                        onClick={switchToBSC}
                        disabled={switching}
                        className="px-4 py-1.5 bg-white text-teal-600 text-xs font-black rounded-lg hover:bg-teal-50 transition-colors disabled:opacity-60"
                    >
