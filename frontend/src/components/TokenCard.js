    ...
    return (
        ...
        >
            <div className="relative w-full aspect-square rounded-xl overflow-hidden mb-4 bg-black/5">
                ...
                <div className="absolute top-2 right-2 px-2 py-1 rounded-lg bg-white/60 backdrop-blur-md border border-black/10 text-[10px] font-bold text-blue-500">
                    BSC
                </div>
            </div>
            ...
            <div className="flex-1">
                <div className="flex items-center justify-between mb-1">
                    ...
                    <span className="text-xs font-mono text-blue-500 bg-indigo-500/10 px-2 py-0.5 rounded-md">
                        {symbol}
                    </span>
                </div>
            ...
            <Link href={`/token/${address}`} className="w-full">
                <button className="w-full py-3 bg-black/5 hover:bg-blue-500 hover:text-white transition-all duration-300 rounded-xl font-bold text-sm border border-black/10 hover:border-blue-500 shadow-lg shadow-black/20">
                    View Detail
                </button>
            </Link>
        </motion.div>
